  ...
  return (
    <main className="min-h-screen w-full bg-gradient-to-br from-slate-300 via-blue-250 to-slate-400 text-white overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none">
        <div
          className="absolute w-64 h-64 md:w-96 md:h-96 bg-blue-500/20 rounded-full blur-3xl transition-all duration-300 ease-out"
          style={{ 
            top: mousePos.y - 128, 
            left: mousePos.x - 128,
            transform: 'scale(0.8)'
        ...
        />
        <div className="absolute top-1/4 right-1/4 w-64 h-64 md:w-96 md:h-96 bg-purple-500/10 rounded-full blur-3xl animate-pulse" />
        <div className="absolute bottom-1/4 left-1/3 w-64 h-64 md:w-96 md:h-96 bg-cyan-500/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: "1s" }} />
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-16 items-center">
            <div className="space-y-6 md:space-y-8 z-10">
              <div className="inline-flex items-center gap-2 px-3 py-1 md:px-4 md:py-2 rounded-full bg-blue-500/10 border border-blue-400/20 backdrop-blur-sm animate-fadeIn">
                ...
                <span className="text-xs md:text-sm font-medium text-blue-900">Enterprise Logistics Platform</span>
              </div>
              ...
              <p className="text-base md:text-xl text-slate-700 leading-relaxed max-w-xl animate-slideUp" style={{ animationDelay: "0.1s" }}>
              ...
              <div className="grid grid-cols-3 gap-3 md:gap-6 pt-6 md:pt-8 animate-slideUp" style={{ animationDelay: "0.3s" }}>
                {[
                  ...
                  <div key={i} className="group">
                    <div className="p-2 md:p-3 rounded-xl bg-gradient-to-br from-blue-500/10 to-purple-500/10 border border-blue-400/20 backdrop-blur-sm group-hover:scale-105 transition-transform">
            ...
            <div className="relative z-10 animate-slideUp" style={{ animationDelay: "0.2s" }}>
              <div className="relative">
                ...
                <div className="relative p-4 md:p-8 rounded-2xl md:rounded-3xl bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-xl border border-slate-700/50 shadow-2xl">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
            {[
              ...
              <div key={i} className="group relative p-4 md:p-8 rounded-2xl md:rounded-3xl bg-gradient-to-br from-slate-800/30 to-slate-900/30 backdrop-blur-sm border border-slate-700/50 hover:border-slate-600/50 transition-all hover:scale-105">
                ...
                <p className="text-slate-600 text-sm md:text-base leading-relaxed">{f.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="relative py-12 md:py-24 px-4 md:px-10 lg:px-20 bg-gradient-to-b from-transparent via-blue-950/10 to-transparent">
        <div className="max-w-7xl mx-auto text-center mb-8 md:mb-12">
          ...
          <p className="block text-transparent bg-gradient-to-r from-cyan-800 to-blue-500 bg-clip-text max-w-2xl mx-auto mt-2 md:mt-3 text-base md:text-xl">Capabilities designed for operations where reliability, offline resilience, and situational clarity matter most.</p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 max-w-7xl mx-auto">
          <div className="p-4 md:p-6 rounded-2xl bg-gradient-to-br from-slate-800/40 to-slate-900/40 backdrop-blur-sm border border-slate-700/50">
            <div className="inline-flex items-center justify-center p-3 md:p-4 rounded-xl bg-gradient-to-br from-blue-500/10 to-cyan-500/10 mb-3 md:mb-4">
              <Icon name="globe" size={24} />
            </div>
            <h4 className="font-semibold text-base md:text-lg mb-1 md:mb-2">Mesh Mode (Offline Sync)</h4>
            <p className="text-slate-400 text-xs md:text-sm">Drivers form a peer-to-peer mesh when cellular is unavailable. Jobs, signatures and logs sync automatically once any node regains connectivity.</p>
          </div>

          <div className="p-4 md:p-6 rounded-2xl bg-gradient-to-br from-slate-800/40 to-slate-900/40 backdrop-blur-sm border border-slate-700/50">
            <div className="inline-flex items-center justify-center p-3 md:p-4 rounded-xl bg-gradient-to-br from-purple-500/10 to-pink-500/10 mb-3 md:mb-4">
              <Icon name="chart" size={24} />
            </div>
            <h4 className="font-semibold text-base md:text-lg mb-1 md:mb-2">Digital-Twin Replay</h4>
            <p className="text-slate-400 text-xs md:text-sm">Record a vehicle's telemetry and replay routes as a digital twin for post-trip audits, incident reconstruction and process optimization.</p>
          </div>

          <div className="p-4 md:p-6 rounded-2xl bg-gradient-to-br from-slate-800/40 to-slate-900/40 backdrop-blur-sm border border-slate-700/50">
            <div className="inline-flex items-center justify-center p-3 md:p-4 rounded-xl bg-gradient-to-br from-green-500/10 to-emerald-500/10 mb-3 md:mb-4">
              <Icon name="truck" size={24} />
            </div>
            <h4 className="font-semibold text-base md:text-lg mb-1 md:mb-2">AR Load Visualizer</h4>
            <p className="text-slate-400 text-xs md:text-sm">Use the driver device camera to validate load placement with an augmented overlay — reduces damage and speeds loading checks.</p>
          </div>

          <div className="p-4 md:p-6 rounded-2xl bg-gradient-to-br from-slate-800/40 to-slate-900/40 backdrop-blur-sm border border-slate-700/50">
            <div className="inline-flex items-center justify-center p-3 md:p-4 rounded-xl bg-gradient-to-br from-yellow-500/10 to-orange-500/10 mb-3 md:mb-4">
              <Icon name="shield" size={24} />
            </div>
            <h4 className="font-semibold text-base md:text-lg mb-1 md:mb-2">Edge-First Privacy</h4>
            <p className="text-slate-400 text-xs md:text-sm">Sensitive processing runs at the device edge where possible; only operational metadata is transmitted to servers to preserve privacy and latency.</p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-9">
            {[
              ...
              <div key={i} className="relative pt-16 md:pt-20">
                <div className="text-6xl md:text-8xl font-black text-slate-800/50 absolute -top-6 md:-top-8 pointer-events-none">{s.step}</div>
                <div className="relative p-4 md:p-8 rounded-2xl md:rounded-3xl bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-sm border border-slate-700/50 hover:border-slate-600/50 transition-all hover:scale-105 group">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8">
            {[
              ...
              <div key={i} className="p-4 md:p-8 rounded-2xl md:rounded-3xl bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-sm border border-slate-700/50 hover:border-slate-600/50 transition-all hover:scale-105">
                <div className="flex gap-1 mb-4 md:mb-6">
                  {[...Array(5)].map((_, j) => <Icon key={j} name="star" size={16} />)}
                </div>
                <p className="text-slate-300 text-sm md:text-base leading-relaxed mb-4 md:mb-6 italic">"TransConnect transformed our operations. Real-time visibility and smarter routing reduced our delivery times significantly."</p>
                <div className="flex items-center gap-3 md:gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-xs md:text-sm text-slate-400">{t.role}</div>
      ...
      <section className="relative py-16 md:py-32 px-4 md:px-10 lg:px-20">
        <div className="max-w-4xl mx-auto text-center">
          <div className="p-6 md:p-16 rounded-2xl md:rounded-3xl bg-gradient-to-br from-blue-500/20 to-purple-500/20 backdrop-blur-xl border border-blue-400/30">
            ...
            <p className="text-base md:text-xl text-slate-300 mb-6 md:mb-8 max-w-2xl mx-auto">Join thousands of companies already running reliable fleets with TransConnect.</p>
            <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center">
              ...
              <button className="px-6 py-3 md:px-10 md:py-5 rounded-full font-bold text-sm md:text-lg border-2 border-blue-400/30 backdrop-blur-sm hover:bg-blue-400/10 transition-all hover:scale-105">Schedule Demo</button>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* FOOTER */}
      <footer className="relative py-8 md:py-16 px-4 md:px-10 lg:px-20 border-t border-slate-800">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6 md:gap-8 mb-6 md:mb-8">
            <div className="text-center md:text-left">
              ...
              <div className="text-slate-500 text-sm md:text-base">Reliable logistics for modern teams</div>
            </div>
            <div className="flex items-center gap-4 md:gap-6">
              <a href="#" className="text-slate-600 hover:text-white transition-colors text-sm md:text-base">Features</a>
              <a href="#" className="text-slate-600 hover:text-white transition-colors text-sm md:text-base">About</a>
              <a href="#" className="text-slate-600 hover:text-white transition-colors text-sm md:text-base">Contact</a>
            </div>
          </div>
          <div className="text-center text-slate-500 text-xs md:text-sm">© {new Date().getFullYear()} TransConnect. Built with precision for logistics excellence.</div>
        </div>
      </footer>
