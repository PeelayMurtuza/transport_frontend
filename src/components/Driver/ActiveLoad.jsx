          ...
          <div className="flex items-center justify-between h-16 sm:h-20 py-2">
            <div className="flex items-center space-x-2 sm:space-x-3 lg:space-x-4">
              ...
              <div>
                ...
                <div className="flex items-center space-x-2 sm:space-x-3 mt-1">
                  <div className={`px-2 sm:px-3 py-1 rounded-full text-xs sm:text-sm font-bold ${getStatusColor(tripStatus)} shadow-sm`}>
                    {getStatusText(tripStatus)}
                  </div>
                  <div className="text-blue-600 text-xs sm:text-sm font-mono bg-blue-50 px-2 py-1 rounded-lg">
            ...
            <div className="flex items-center space-x-3 sm:space-x-4 lg:space-x-6">
              <div className="text-right hidden xs:block">
                <div className="text-xs sm:text-sm text-slate-600">Elapsed Time</div>
                <div className="text-lg sm:text-xl lg:text-2xl font-bold text-slate-900 font-mono">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
          ...
          <div className="xl:col-span-2 space-y-4 sm:space-y-6">
            ...
            <motion.div
              ...
              className="bg-white rounded-2xl sm:rounded-3xl shadow-lg sm:shadow-xl border border-slate-200 overflow-hidden"
            >
              <div className="p-4 sm:p-6 lg:p-8">
                <div className="flex flex-col xs:flex-row xs:items-center justify-between mb-4 sm:mb-6 lg:mb-8 gap-3">
                  <h2 className="text-lg sm:text-xl lg:text-2xl font-bold text-slate-900">Route Progress</h2>
                  <div className="flex items-center space-x-2 sm:space-x-3">
                    ...
                    <button 
                      ...
                      className="p-2 sm:p-3 bg-slate-100 hover:bg-slate-200 rounded-xl sm:rounded-2xl transition-colors"
                    >
                ...
                <div className="space-y-4 sm:space-y-6">
                  ...
                  <div className="flex items-center space-x-3 sm:space-x-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="text-slate-900 font-semibold text-sm sm:text-base">{activeLoad.from.city}</div>
                      <div className="text-slate-600 text-xs sm:text-sm truncate">{activeLoad.from.address}</div>
                      <div className="text-emerald-600 text-xs sm:text-sm mt-1 flex items-center">
                        <CheckCircle2 className="w-3 h-3 sm:w-4 sm:h-4 mr-1" />
                        Pickup Completed
                      </div>
                    </div>
                    <div className="text-right flex-shrink-0">
                      <div className="text-slate-500 text-xs sm:text-sm">08:15 AM</div>
                    </div>
                  </div>
                  ...
                  <div className="relative">
                    ...
                    <div className="ml-8 sm:ml-12 space-y-4 sm:space-y-6 lg:space-y-8">
                      ...
                      <div className="flex items-center space-x-3 sm:space-x-4">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="text-cyan-700 font-semibold text-sm sm:text-base">Current Location</div>
                          <div className="text-slate-600 text-xs sm:text-sm">Approaching Bakersfield, CA</div>
                          <div className="text-cyan-600 text-xs sm:text-sm mt-1 font-medium">
                            {activeLoad.distance.traveled} mi traveled • {activeLoad.distance.remaining} mi to go
                          </div>
                        </div>
                        <div className="text-right flex-shrink-0">
                          <div className="text-slate-900 font-bold text-sm sm:text-base">{activeLoad.timeline.currentSpeed} mph</div>
                          <div className="text-slate-500 text-xs sm:text-sm">Current Speed</div>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center space-x-3 sm:space-x-4">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="text-slate-900 font-semibold text-sm sm:text-base">{activeLoad.to.city}</div>
                          <div className="text-slate-600 text-xs sm:text-sm truncate">{activeLoad.to.address}</div>
                          <div className="text-purple-600 text-xs sm:text-sm mt-1 font-medium">
                            ETA: {activeLoad.timeline.estimatedArrival}
                          </div>
                        </div>
                        <div className="text-right flex-shrink-0">
                          <div className="text-slate-500 text-xs sm:text-sm">02:00 PM</div>
                          <div className="text-slate-400 text-xs sm:text-sm">Scheduled</div>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                {/* Distance Metrics */}
                <div className="grid grid-cols-3 gap-3 sm:gap-4 lg:gap-6 mt-4 sm:mt-6 lg:mt-8 pt-4 sm:pt-6 lg:pt-8 border-t border-slate-200">
                  {[
                    ...
                    <div key={index} className={`text-center p-3 sm:p-4 rounded-xl sm:rounded-2xl ${metric.bg}`}>
                      <div className={`text-lg sm:text-xl lg:text-2xl font-bold ${metric.color}`}>{metric.value}</div>
                      <div className="text-slate-600 text-xs sm:text-sm font-medium">{metric.label}</div>
                    </div>
                  ))}
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
              ...
              >
                <div className="p-4 sm:p-6">
                  <div className="flex flex-col xs:flex-row xs:items-center justify-between mb-4 sm:mb-6 gap-2">
                    <h3 className="text-base sm:text-lg lg:text-xl font-bold text-slate-900">Live Route Tracking</h3>
                  ...
                  {/* Map Container */}
                  <div className="bg-gradient-to-br from-blue-50 to-cyan-100 rounded-xl sm:rounded-2xl h-48 sm:h-56 lg:h-64 relative overflow-hidden border border-slate-200">
                    {/* Simulated Map */}
                    <div className="absolute inset-0 bg-gradient-to-br from-blue-100 to-cyan-200">
                      {/* Route Line */}
                      <div className="absolute left-1/4 top-1/3 right-1/4 h-0.5 sm:h-1 bg-cyan-300 rounded-full">
                        <div 
                    ...
                    <div className="absolute bottom-3 sm:bottom-4 left-3 sm:left-4 right-3 sm:right-4">
                      <div className="flex flex-col xs:flex-row xs:justify-between xs:items-center gap-2">
                        <div className="flex space-x-1 sm:space-x-2">
                          <button className="px-2 sm:px-3 py-1 sm:py-2 bg-white/90 backdrop-blur-sm text-slate-700 rounded-lg sm:rounded-xl text-xs sm:text-sm font-semibold hover:bg-white transition-colors shadow-sm">
                            Satellite
                          </button>
                          <button className="px-2 sm:px-3 py-1 sm:py-2 bg-white/90 backdrop-blur-sm text-slate-700 rounded-lg sm:rounded-xl text-xs sm:text-sm font-semibold hover:bg-white transition-colors shadow-sm">
                            Traffic
                        ...
                        <button className="p-1 sm:p-2 bg-white/90 backdrop-blur-sm text-slate-700 rounded-lg sm:rounded-xl hover:bg-white transition-colors shadow-sm self-start xs:self-auto">
                          <Navigation className="w-3 h-3 sm:w-4 sm:h-4" />
                        </button>
                      </div>
                    </div>
              ...
              >
                <h3 className="text-base sm:text-lg lg:text-xl font-bold text-slate-900 mb-4 sm:mb-6">Vehicle Status</h3>
                <div className="grid grid-cols-2 gap-2 sm:gap-3 lg:gap-4">
                  {[
                    ...
                    <div key={index} className={`text-center p-3 sm:p-4 rounded-xl sm:rounded-2xl ${stat.bg}`}>
                      <stat.icon className={`w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 mx-auto mb-1 sm:mb-2 ${stat.color}`} />
                      <div className={`text-sm sm:text-base lg:text-lg font-bold ${stat.color}`}>{stat.value}</div>
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            <motion.div
              ...
              className="bg-white rounded-2xl sm:rounded-3xl shadow-lg sm:shadow-xl border border-slate-200 p-4 sm:p-6"
            >
              <h3 className="text-base sm:text-lg lg:text-xl font-bold text-slate-900 mb-4 sm:mb-6">Trip Controls</h3>
              ...
              <div className="space-y-3 sm:space-y-4">
                {[
                  ...
                  <motion.button
                    ...
                    className={`w-full p-3 sm:p-4 rounded-xl sm:rounded-2xl text-white font-semibold transition-all duration-300 shadow-lg ${
                      action.disabled 
            ...
            <motion.div
              ...
              className="bg-white rounded-2xl sm:rounded-3xl shadow-lg sm:shadow-xl border border-slate-200 p-4 sm:p-6"
            >
              <h3 className="text-base sm:text-lg lg:text-xl font-bold text-slate-900 mb-4 sm:mb-6">Contact Support</h3>
              ...
              <div className="space-y-3 sm:space-y-4">
                ...
                <div className="bg-blue-50 rounded-xl sm:rounded-2xl p-3 sm:p-4 border border-blue-100">
                  <div className="flex items-center space-x-2 sm:space-x-3 mb-2 sm:mb-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="text-slate-900 font-semibold text-sm sm:text-base truncate">{activeLoad.contact.agent.name}</div>
                      <div className="text-cyan-600 text-xs sm:text-sm font-medium">Load Agent</div>
                    </div>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <button className="flex items-center justify-center space-x-1 sm:space-x-2 p-2 sm:p-3 bg-blue-500 hover:bg-blue-600 rounded-lg sm:rounded-xl text-white font-semibold transition-colors shadow-lg text-xs sm:text-sm">
                      <Phone className="w-3 h-3 sm:w-4 sm:h-4" />
                      <span>Call</span>
                    </button>
                    <button className="flex items-center justify-center space-x-1 sm:space-x-2 p-2 sm:p-3 bg-emerald-500 hover:bg-emerald-600 rounded-lg sm:rounded-xl text-white font-semibold transition-colors shadow-lg text-xs sm:text-sm">
                ...
                <div className="bg-purple-50 rounded-xl sm:rounded-2xl p-3 sm:p-4 border border-purple-100">
                  <div className="flex items-center space-x-2 sm:space-x-3 mb-2 sm:mb-3">
                    ...
                    <div className="min-w-0">
                      <div className="text-slate-900 font-semibold text-sm sm:text-base truncate">{activeLoad.contact.shipper.name}</div>
                      <div className="text-purple-600 text-xs sm:text-sm font-medium">Shipper</div>
                    </div>
                  </div>
                  
                  <button className="w-full flex items-center justify-center space-x-1 sm:space-x-2 p-2 sm:p-3 bg-purple-500 hover:bg-purple-600 rounded-lg sm:rounded-xl text-white font-semibold transition-colors shadow-lg text-xs sm:text-sm">
                    <Phone className="w-3 h-3 sm:w-4 sm:h-4" />
            ...
            <motion.div
              ...
              className="bg-white rounded-2xl sm:rounded-3xl shadow-lg sm:shadow-xl border border-slate-200 p-4 sm:p-6"
            >
              <h3 className="text-base sm:text-lg lg:text-xl font-bold text-slate-900 mb-4 sm:mb-6">Cargo Details</h3>
              
              <div className="space-y-3 sm:space-y-4">
                <div className="bg-amber-50 rounded-xl sm:rounded-2xl p-3 sm:p-4 border border-amber-100">
                  <div className="flex items-center space-x-2 sm:space-x-3 mb-2 sm:mb-3">
                    <Package className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 text-amber-600" />
                    <div className="min-w-0">
                      <div className="text-slate-900 font-semibold text-sm sm:text-base truncate">{activeLoad.cargo.type}</div>
                      <div className="text-amber-600 text-xs sm:text-sm">Weight: {activeLoad.cargo.weight}</div>
                    </div>
                  </div>
                  
                  <div className="flex flex-wrap gap-1 sm:gap-2">
                    {activeLoad.cargo.specialRequirements.map((req, index) => (
                      <span key={index} className="px-2 py-1 bg-amber-100 text-amber-700 rounded-md sm:rounded-lg text-xs font-medium border border-amber-200">
                        {req}
                      </span>
                    ))}
                  </div>
            ...
            <motion.div
              ...
              className="bg-white rounded-2xl sm:rounded-3xl shadow-lg sm:shadow-xl border border-slate-200 p-4 sm:p-6"
            >
              <h3 className="text-base sm:text-lg lg:text-xl font-bold text-slate-900 mb-4 sm:mb-6">Quick Actions</h3>
              ...
              <div className="grid grid-cols-2 gap-2 sm:gap-3 lg:gap-4">
                {[
                  ...
                  <button
                    key={index}
                    className={`p-3 sm:p-4 rounded-xl sm:rounded-2xl text-white font-semibold bg-gradient-to-r ${action.color} hover:shadow-lg transition-all duration-300 hover:scale-105 text-xs sm:text-sm`}
                  >
