      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        >
          <div>
            ...
            <p className="text-gray-600 mt-2">Comprehensive insights into your logistics performance</p>
          </div>
        ...
        <AnimatePresence mode="wait">
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-6 shadow-2xl border border-gray-200/50">
                <div className="flex items-center justify-between mb-6">
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">Earnings over time</p>
                  </div>
          ...
          {activeTab === "performance" && (
            ...
            >
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-6 shadow-2xl border border-gray-200/50">
                <div className="flex items-center justify-between mb-6">
                  <h3 className="text-lg font-semibold text-gray-900">Distance Covered</h3>
            ...
            >
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-gray-600 text-sm">Monthly revenue breakdown and trends</p>
                </div>
                <div className="flex items-center gap-2">
              ...
              <div key={index} className="flex items-center justify-between p-4 bg-gray-50/50 rounded-2xl hover:bg-gray-100/50 transition-colors">
                <div className="flex items-center gap-4">
                  <div className={`w-10 h-10 rounded-2xl flex items-center justify-center ${
                    ...
                    {activity.type === "revenue" && <Package className="text-blue-500" size={18} />}
                    {activity.type === "commission" && <DollarSign className="text-green-500" size={18} />}
                    {activity.type === "completion" && <CheckCircle className="text-purple-500" size={18} />}
                    {activity.type === "payment" && <TrendingUp className="text-orange-500" size={18} />}
                  </div>
